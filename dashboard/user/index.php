...
if (!isset($_SESSION['userSession'])) {
    header("Location: user-signin.php"); // ✅ Avoid redirect loop
    exit();
}
...
// Get user info
$stmt = $conn->prepare("SELECT full_name, email, status, created_at FROM users WHERE user_id = ?");
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar">
                ...
                <a href="user-signout.php">🚪 Logout</a>
            ...
            <div class="col-md-9 col-lg-10 content">
                <nav class="navbar navbar-light bg-light mb-4">
                    <div class="container-fluid">
                        <span class="navbar-brand mb-0 h1">Welcome, <?php echo htmlspecialchars($userData['full_name']); ?></span>
                    </div>
                </nav>
